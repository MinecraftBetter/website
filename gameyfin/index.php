...
<div class="mx-auto" style="max-width: calc(100vw - 3em);max-height: calc(100vh - 3em);">
    <main role="main">
        <div class="d-flex flex-column w-100 introduction overflow-hidden" style="min-height: unset;">
            <div class="text-center" style="position: relative;">
                ...
                <p class="lead text-wrap">La plateforme à laquelle vous accédez ne contient que des jeux <strong>sans DRM</strong> obtenus de manière <strong>légale</strong>.</p>
                <p class="lead text-wrap">Si vous souhaitez participer à l'étoffement du catalogue, merci de contacter <strong><em>mikaleplubo</em></strong>.</p>
                <p class="lead text-wrap">Dû à la quantité de jeux mis à votre disposition, tous n'ont pu être testé,<br/>si un jeu ne se lance pas, merci de nous en informer.</p>
                <p class="lead text-wrap" id="buttons" style="flex-wrap: wrap; margin-top: 2.5rem; justify-content: center;">
